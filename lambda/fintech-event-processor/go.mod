module github.com/HELL0ANTHONY/fintech-event-processing-service/lambda/fintech-event-processor

go 1.25.6

require (
	github.com/HELL0ANTHONY/fintech-event-processing-service/shared v0.0.0
